...
export const Route = createFileRoute('/dashboard/organizer/tickets')({
  component: Page,
  head: () => ({ meta: [{ title: 'Tickets — VibeCam' }] }),
});
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-20 md:pb-12 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">Tickets</h1>
